...
class CitaChecker:
    ...
    BARCELONA_URL = "https://icp.administracionelectronica.gob.es/icpplustieb/citar?p=8&locale=es"
    
    # Form values for Barcelona - Toma de Huellas
    PROVINCIA = "Barcelona"
    TRAMITE_VALUE = "4010"  # Value for POLICÍA-TOMA DE HUELLAS
    TRAMITE_NAME = "POLICÍA-TOMA DE HUELLAS (EXPEDICIÓN DE TARJETA) INICIAL, RENOVACIÓN, DUPLICADO Y LEY 14/2013"
    ...
    def check_availability(self):
        ...
        try:
            ...
            try:
                ...
                select_oficina.select_by_value("99")
                logger.info("Selected 'Cualquier oficina' (checking all offices)")
